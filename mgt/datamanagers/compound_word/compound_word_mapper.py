...
class CompoundWord(object):
    ...
    def __repr__(self):
        ...
        return f'CompoundWord(type={type_string}, bar_beat={self.bar_beat}, instrument={self.instrument}, note_name={self.note_name}, octave={self.octave}, duration={self.duration})'
...
class CompoundWordMapper(object):
    ...
    def map_compound_note_to_remi(self, compound_word, current_position):
        ...
        velocity = 20 + self.note_velocity_offset
