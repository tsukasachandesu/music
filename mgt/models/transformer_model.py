...
class TransformerModel(object):
    ...
    def train(self, x_train, epochs, batch_size=15, stop_loss=None, batches_per_epoch=150, report_per_x_batches=20,
    ...
    def create_model(self):
        model = BlockRecurrentTransformer(
          ...
          max_seq_len = 3000,             # the total receptive field of the transformer, in the paper this was 2 * block size
          block_width = 1500,              # block size - total receptive field is max_seq_len, 2 * block size in paper. the block furthest forwards becomes the new cached xl memories, which is a block size of 1 (please open an issue if i am wrong)
