...
class CompoundWordAutoregressiveWrapper(nn.Module):
    ...
    def train_step(self, x, **kwargs):
        ...
        proj_barbeat, proj_note_name = self.net.forward_output(
            h, target)
        ...
        note_name_loss = calculate_loss(proj_note_name, target[..., 2], type_mask(target))
        
        return type_loss, barbeat_loss, note_name_loss
