...
model = AutoregressiveWrapper(TransformerWrapper(
  num_tokens=568,
  max_seq_len=SEQ_LEN,
  attn_layers=Decoder(dim=512,depth=17,heads=13,ff_swish = True,ff_glu = True, attn_dropout=0.1, ff_dropout=0.1,rotary_xpos = True)), mask_prob = 0.15,ignore_index=0,pad_value=0).cuda()
